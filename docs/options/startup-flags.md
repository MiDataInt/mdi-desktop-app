...
The following are yes/no options that determine how your MDI server will start.
...
The default behavior of `mdi::run()` is to check the
MDI frameworks and tool suites for updates prior to 
